...
FORTUNES = [
    ...
    "The weather will be hot, cold or just right today. Probably hot though.",
    "Your dog will need to be let out shortly.",
    "Your Next Fortune Cookie will be a good one.",
